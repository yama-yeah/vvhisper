...
abstract class $MessageModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String url, String type, int id});
}
...
class _$_MessageModel implements _MessageModel {
  const _$_MessageModel(
      {required this.url, required this.type, required this.id});
  ...
  @override
  String toString() {
    return 'MessageModel(url: $url, type: $type, id: $id)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, url, type, id);
...
abstract class _MessageModel implements MessageModel {
  const factory _MessageModel(
      ...
      required final int id}) = _$_MessageModel;
